...
static const double MAX_ADMISIBLE_VEL     = 0.8;  //82 km/h
static const double MAX_ADMISIBLE_STEERING_ANG = 1.76; //  35 deg, original value was 0.6109
...
//static const double TIRE_TO_DRIVINGWHEEL_RATIO = 15.52; //for matsu
static const double TIRE_TO_DRIVINGWHEEL_RATIO = 1.0;
...
*/
	...
	set_w = prev_set_w + omega_dot ;
	*/

	std::cerr << ros::Time::now();
	std::cerr << " control_max_vel " << set_v << " " << set_v*3.6 << " km/h"; 	
	std::cerr << " ang_vel " << set_w << " " << set_w*180/M_PI << " deg\n"; 
