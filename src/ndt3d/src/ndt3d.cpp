...
/*grobal variables*/
NDMapPtr NDmap;/*ï¿½ï¿½ï¿½Ö²ï¿½ï¿½ï¿½ï¿½ï¿½*/
NDPtr NDs;
int NDs_num;
...
//	if(layer_select!=1 && j>2)break;
    ...
    if(g_use_gnss){
      ...
      fprintf(e_fp,"%f\n",e);
	// ¤³¤Î¾ò·ï¤Ë¤Ê¤ë¤È¤¤¤¦¤³¤È¤Ï¼ýÂ«¤·¤Æ¤¤¤Ê¤¤¤È¤¤¤¦¤³¤È¤ÈÈ½Äê¤·¤Æ¤¤¤ë
	// ¤È¤ê¤¢¤¨¤º¡¢¼¡²ó¿äÄê¤Î½é´üÃÍ¤òGPS¤ÎÃÍ¤Ë½¤Àµ¤¹¤ë¤¬¡¢¥í¥Ü¥Ã¥È¤Î°ÌÃÖ¤Þ¤Ç¤Ï½¤Àµ¤·¤Ê¤¤
...
NDMapPtr initialize_NDmap(void){
  ...
  return ndmap;/*ï¿½ï¿½ï¿½Ö²ï¿½ï¿½ï¿½ï¿½Ø¤Î¥Ý¥ï¿½ï¿½ó¥¿¤ï¿½ï¿½Ö¤ï¿½*/
}
...
/*ï¿½ï¿½ï¿½ï¿½NDï¿½Ü¥ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ç¤Î¤ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ö¤Ç¤Î³ï¿½Î¨*/
